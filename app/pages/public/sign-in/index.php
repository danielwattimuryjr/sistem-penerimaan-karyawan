        ...
        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh ">
            ...
            <form action="post.php" method="POST" class="mt-3" style="width: 50%">
                ...
                <div class="d-flex justify-content-center flex-column" style="width: 100%">
                    ...
                    <div
                        class="d-flex flex-row justify-content-center align-items-center justify-content-lg-between mt-4 text-center">
                        <a href="/pages/public/forget-password" style="text-decoration: none">
                            Lupa Password?
                        </a>
                        <a href="/pages/public/register" style="text-decoration: none">
                            Register
                        </a>
                    </div>
                </div>

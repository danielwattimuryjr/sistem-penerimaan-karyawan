...
$sql = "
    SELECT 
        d.id_divisi,
        d.nama_divisi,
        d.jumlah_personil AS jumlah_max,
        COUNT(k.id_karyawan) AS jumlah_saat_ini,
        (COUNT(k.id_karyawan) < d.jumlah_personil) AS isInNeed
    FROM divisi d
    LEFT JOIN karyawan k ON d.id_divisi = k.id_divisi
    WHERE d.id_user = ?
    GROUP BY d.id_divisi, d.nama_divisi, d.jumlah_personil
              ...
              <div class="card-body">
                <form action="store.php" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea cols="30" rows="5" class="form-control" name="alamat" required></textarea>
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Divisi</label>
                    <select class="form-select" name="id_divisi" required>
                      <option selected disabled>-- PILIH DIVISI YANG KEKURANGAN PERSONIL --</option>

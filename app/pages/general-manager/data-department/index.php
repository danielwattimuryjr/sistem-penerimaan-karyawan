                        ...
                        <div class="card">
                            <div class="card-header">
                                <div
                                    ...
                                    <a href="/pages/general-manager/form-create-department"
                                    ...
                                    <table class="table" id="data-table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($result as $res) { ?>
                                                    <?php
                                                    $baseEditUrl = '/pages/general-manager/form-edit-department';
                                                    $baseDeleteUrl = '/pages/general-manager/data-department/delete.php';

                ...
                <div
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-9 col-xl-7 mx-auto">
                            ...
                            <form method="post" action="post-register-request.php">
                                <div class="mb-5">
                            ...
                            <div class="my-6">
                                ...
                                <a href="/sistem-penerimaan-karyawan/pages/public/sign-in"
                                    class="text-warning text-sm font-semibold">Login di sini</a>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-9 col-xl-7 mx-auto">
                            ...
                            <form method="post" action="post-sign-in-request.php">
                                <div class="mb-5">
                            ...
                            <div class="my-6">
                                ...
                                <a href="/sistem-penerimaan-karyawan/pages/public/register"
                                    class="text-warning text-sm font-semibold">Register di sini</a>
                            </div>
                        </div>
                    </div>
                </div>

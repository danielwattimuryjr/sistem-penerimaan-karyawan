    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="/sistem-penerimaan-karyawan/pages/hrd/beranda">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/sistem-penerimaan-karyawan/pages/hrd/permintaan-karyawan">Permintaan Karyawan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/sistem-penerimaan-karyawan/pages/hrd/data-pelamar">Data Pelamar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/sistem-penerimaan-karyawan/pages/hrd/data-kriteria">Data Kriteria</a>
                </li>
                <li class="nav-item">

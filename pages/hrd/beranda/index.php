            ...
            <div class="page-content">
                <section class="row">
                    <div class="col-12">
                        <div class="card">
                            <div
                                class="card-header d-flex flex-column flex-lg-row justify-content-start justify-content-lg-between align-items-start align-items-lg-center">
                                <h5 class="card-title">Daftar Lowongan Pekerjaan</h5>

                                <a href="/sistem-penerimaan-karyawan/pages/hrd/form-create-lowongan"
